...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        *,
        ...
        # P2 weighting
        if self.mse_loss_weight_type.startswith("p2weight_"):
            p2_gamma, p2_k = self.mse_loss_weight_type.split("_")[-2:]
    ...
    def training_losses(self, model, x_start, t, uw=None, model_kwargs=None, noise=None):
        """
        ...
        # get loss weight
        if self.mse_loss_weight_type in ["uw", "constant"]:
            mse_loss_weight = th.ones_like(t)
        elif self.mse_loss_weight_type.startswith("p2weight_"):
            mse_loss_weight = _extract_into_tensor(
                1 / (self.p2_k + self.snr) ** self.p2_gamma, t, x_start.shape
            )
